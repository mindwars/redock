...
func selectPhpServices() string {
	...
	selectBox := &survey.Select{Message: "Pick your service", Options: []string{"php56", "php70", "php71", "php72", "php74", "php80", "php81", "php56_xdebug", "php72_xdebug", "php74_xdebug", "php80_xdebug", "php81_xdebug"}}
